...
<div class="mx-auto max-w-6xl">
	...
	<p class="mt-1 text-sm text-tertiary">Přehled vašeho podnikání</p>
	...
	<div class="mt-8">
		<h2 class="text-base font-semibold text-primary">Poslední aktivita</h2>
		<Card class="mt-4 text-center text-sm text-muted">
			Zatím žádná aktivita. Začněte vytvořením první faktury.
		</Card>
	</div>
</div>
