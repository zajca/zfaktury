				...
				<div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
					...
					<div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
						...
						<div>
							...
							<input id="edit-next" type="date" bind:value={form.next_issue_date} class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none" />
						</div>
						<div>
