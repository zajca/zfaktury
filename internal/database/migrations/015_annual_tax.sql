...
DROP TABLE IF EXISTS income_tax_return_expenses;
DROP TABLE IF EXISTS income_tax_return_invoices;
DROP TABLE IF EXISTS income_tax_returns;
DROP TABLE IF EXISTS social_insurance_overviews;
DROP TABLE IF EXISTS health_insurance_overviews;
